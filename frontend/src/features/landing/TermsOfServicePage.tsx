...
const SECTIONS = [
  ...
  { id: "terms-accounts", title: "2. Accounts & Eligibility" },
  { id: "terms-conduct", title: "3. Acceptable Use" },
  { id: "terms-content", title: "4. User Content" },
  { id: "terms-services", title: "5. Services & Availability" },
  { id: "terms-privacy", title: "6. Privacy" },
  { id: "terms-termination", title: "7. Suspension & Termination" },
  { id: "terms-liability", title: "8. Disclaimers & Liability" },
  { id: "terms-changes", title: "9. Changes to These Terms" },
  { id: "terms-contact", title: "10. Contact" },
] as const;
    ...
    <div className="pt-24 pb-16 px-4 min-h-screen" style={{ background: C.bg }}>
      <div className="max-w-3xl mx-auto">
        ...
        <article className="rounded-2xl border p-5 sm:p-8 space-y-8" style={{ background: C.surface, borderColor: C.outlineVar, boxShadow: SH1 }}>
          <section id="terms-acceptance" className="scroll-mt-24">
          ...
          <section id="terms-conduct" className="scroll-mt-24">
          ...
          <section id="terms-content" className="scroll-mt-24">
          ...
          <section id="terms-services" className="scroll-mt-24">
          ...
          <section id="terms-privacy" className="scroll-mt-24">
          ...
          <section id="terms-termination" className="scroll-mt-24">
          ...
          <section id="terms-contact" className="scroll-mt-24">
